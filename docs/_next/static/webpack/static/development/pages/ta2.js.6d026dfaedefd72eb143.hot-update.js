...
var CANDIDATE_GAIN = [0.001, 0.002, 0.003, 0.004, 0.006, 0.01]; // .map(e => e / 1000 / 1000 / 1000 / 1000 / 1000 / 1000 / 1000);
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Ta1, [{
    ...
    value: function initAudio() {
      ...
      this.oscillator.connect(this.gainNode); // this.panNode.connect(this.gainNode);

      this.gainNode.connect(this.audioContext.destination); // this.oscillator.connect(this.gainNode);
    ...
    value: function startAudio() {
      ...
      this.oscillator.connect(this.panNode); // this.panNode.connect(this.gainNode);

      this.panNode.connect(this.audioContext.destination); // this.oscillator.connect(this.gainNode);
      // this.gainNode.connect(this.audioContext.destination);
    ...
    value: function render() {
      ...
      if (this.state.isFinished) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
          ...
          __self: this
        }, "\uBCFC\uB968"), "\uC744", react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("br", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 200
          },
          __self: this
        }), "\uB2E4\uC2DC ", react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("span", {
          className: "text-primary",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 201
          ...
          __self: this
        }, "\uB0AE\uCDB0"), "\uC8FC\uC138\uC694"))), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_10__["Row"], {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 205
          },
          ...
          __self: this
        }, "\uC758\uB8CC\uD589\uC704\uB97C \uB300\uCCB4\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.")), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(_src_components_text__WEBPACK_IMPORTED_MODULE_11__["Guidance"], {
          className: "ml-3 mt-2",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 241
          ...
          __self: this
        }, "* \uAC80\uC0AC \uC885\uB8CC \uD6C4 ", react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("span", {
          className: "text-primary",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 242
          ...
          __self: this
        }, "\uAE30\uAE30\uC758 \uBCFC\uB968"), "\uC744 \uB2E4\uC2DC ", react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("span", {
          className: "text-primary",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 243
...
//# sourceMappingURL=ta2.js.6d026dfaedefd72eb143.hot-update.js.map